package com.priitlaht.maurus.frontend.common.filter;
...
public class CachingHttpHeadersFilter implements Filter {
  ...
  public void init(FilterConfig filterConfig) throws ServletException {
    CACHE_TIME_TO_LIVE = TimeUnit.DAYS.toMillis(environment.getProperty("jhipster.http.cache.timeToLiveInDays", Long.class, 31L));
  }
