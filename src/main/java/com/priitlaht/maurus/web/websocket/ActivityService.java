package com.priitlaht.maurus.web.websocket;

import com.priitlaht.maurus.config.Constants;
import com.priitlaht.maurus.security.SecurityUtils;
import com.priitlaht.maurus.web.websocket.dto.ActivityDTO;
...
public class ActivityService implements ApplicationListener<SessionDisconnectEvent> {
  ...
  public ActivityDTO sendActivity(@Payload ActivityDTO activityDTO, StompHeaderAccessor stompHeaderAccessor, Principal principal) {
    ...
    activityDTO.setIpAddress(stompHeaderAccessor.getSessionAttributes().get(Constants.IP_ADDRESS).toString());
