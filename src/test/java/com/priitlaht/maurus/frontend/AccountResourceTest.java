...
import com.priitlaht.maurus.frontend.account.AccountResource;
...
public class AccountResourceTest {
  ...
  public void testRegisterValid() throws Exception {
    UserDTO u = new UserDTO(
      ...
      true,                   // activated
      "en",                   // langKey
      new HashSet<>(singletonList(AuthoritiesConstants.USER)),
      "image/jpeg",
      new byte[0]
    );
  ...
  public void testRegisterAdminIsIgnored() throws Exception {
    UserDTO u = new UserDTO(
      ...
      true,                   // activated
      "en",                   // langKey
      new HashSet<>(singletonList(AuthoritiesConstants.ADMIN)), // <-- only admin should be able to do that,
      "image/jpeg",
      new byte[0]
    );
